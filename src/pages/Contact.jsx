  ...
  return (
    <>
      ...
      <main className="bg-white text-slate-900">
        ...
        <section className="min-h-[70vh] flex flex-col items-center justify-center px-4 pt-28 pb-16 text-center bg-slate-50 animate-scroll md:pt-36 md:pb-20" ref={scrollRef}>
