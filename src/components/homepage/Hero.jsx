            ...
            >
                ...
                <div className="rounded-lg p-8 bg-transparent md:p-14">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 md:gap-4 justify-center items-center hero-animate-2">
                        ...
                        <button className="w-full sm:w-auto px-8 py-3 bg-[#4A001A] border border-[#4A001A] rounded-xl font-semibold text-white text-base shadow-sm hover:shadow-md hover:-translate-y-0.5 transition">
                            S&apos;inscrire
                        </button>
                    </div>
                </div>
