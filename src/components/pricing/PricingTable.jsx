...
export default function PricingTable({
    ...
    return (
        <div className="mb-8 sm:mb-12 md:mb-20 animate-scroll" ref={scrollRef}>
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6 md:mb-8 pricing-header">
            ...
            <div className="bg-white rounded-2xl shadow-xl overflow-hidden border border-slate-200 pricing-table">
