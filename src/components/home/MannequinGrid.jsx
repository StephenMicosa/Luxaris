...
export default function MannequinGrid() {
    ...
    const cardClass = "bg-white border border-slate-200 rounded-3xl w-60 h-80 sm:w-[260px] sm:h-[360px] lg:w-70 lg:h-[400px] overflow-hidden shadow-sm mannequin-card hover:shadow-lg transition-shadow p-0 opacity-100";
