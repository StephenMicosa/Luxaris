...
export default function Footer() {
    return (
        <>
            {/* Red Banner Section */}
            <div className="w-full bg-linear-to-b from-rose-950 to-rose-900 py-16 px-4">
                <div className="mx-auto max-w-6xl flex flex-col items-center text-center gap-6">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 mt-4">
                        <button className="px-8 py-3 bg-white text-rose-950 font-semibold rounded-lg hover:bg-rose-50 transition">
                            S'inscrire
                        </button>
